    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        test.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(MainActivity.this, "Loading Home... ", Toast.LENGTH_SHORT).show();
                startActivity(go);
            }
        });
                ...
                firebaseAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(MainActivity.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Intent avi = new Intent(MainActivity.this, HomeActivity.class);
                            ...
                            if (task.getException() instanceof FirebaseAuthUserCollisionException) {
                                ...
                                Toast.makeText(MainActivity.this, "Unable to register you, please try again ! ", Toast.LENGTH_SHORT).show();
